...
\section[Postuler pour un service - Scénario III]{Scénario III}
    ...
    \begin{figure}[h]
        ...
        \caption{scénario III - a}
        \label{fig:postuler}
    \end{figure}
    \vfill
    Alors, ils peuvent faire glisser le service auquel ils souhaitent postuler sur
    la gauche - figure \ref{fig:postuler}. À nouveau, si l'opération réussit, un snackbar apparaît pour l'indiquer. Si au contraire, une
